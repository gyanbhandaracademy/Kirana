...
const Contact = () => {
  ...
  return (
    <Layout title={"Contact us - Kirana Store"}>
            ...
            <div className="col-md-10 offset-md-1">
              <div className="contact_inner">
                ...
                <div className="contact_info_sec">
                  <h4 className='newText'>Contact Info</h4>
                  <div className="d-flex info_single align-items-center">
                    <i className="fas fa-headset"></i>
                    <span className='newText'>+91 8009 054294</span>
                  </div>
                  <div className="d-flex info_single align-items-center">
                    <i className="fas fa-envelope-open-text"></i>
                    <span className='newText'>info@flightmantra.com</span>
                  </div>
                  <div className="d-flex info_single align-items-center">
                    <i className="fas fa-map-marked-alt"></i>
                    <span className='newText'>1000+ Travel partners and 65+ Service city across India, USA, Canada & UAE</span>
                  </div>
